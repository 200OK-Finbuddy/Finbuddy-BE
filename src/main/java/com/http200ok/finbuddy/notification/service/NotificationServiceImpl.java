...
public class NotificationServiceImpl implements NotificationService {
    ...
    public List<NotificationResponseDto> getNotifications(String memberId) {
        List<Notification> notifications = notificationRepository.findByReceiverIdAndDeletedFalseOrderByCreatedAtDesc(Long.valueOf(memberId));
    ...
    public Long getUnreadCount(String memberId) {
        return notificationRepository.countByReceiverIdAndIsReadFalseAndDeletedFalse(Long.valueOf(memberId));
    }
}
